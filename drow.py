	...
	for (x, y, w, h) in faces:
		...
		if eye_avg_ratio < eye_ratio_threshold:
			...
			if sleep_frames >= max_sleep_frames:
				...
				cv2.putText(frame, "Da phat hien ngu gat", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
		...
		# Neu khong nham mat thi
			...
			cv2.putText(frame, "TI LE: {:.3f}".format(eye_avg_ratio), (10, 30),	cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
